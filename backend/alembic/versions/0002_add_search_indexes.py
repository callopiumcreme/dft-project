...
def upgrade() -> None:
    ...
    # certificates — FK + search fields
    op.create_index("ix_certificates_supplier_id", "certificates", ["supplier_id"])
    op.create_index("ix_certificates_cert_number", "certificates", ["cert_number"])
...
def downgrade() -> None:
    ...
    op.drop_index("ix_certificates_cert_number", table_name="certificates")
